				...
				Outputs: []*Output{
					{
						...
						resolvedStyle: outputStyle{
							fillColor:   mustParseHexColor(t, "#ddd"),
							borderColor: mustParseHexColor(t, "#eee"),
							textColor:   mustParseHexColor(t, "#fff"),
							borderWidth: 44,
							fontFamily:  "Test Font 2",
							fontSize:    55,
				...
				Outputs: []*Output{
					{
						...
						Mode: "1920x1080@59.960",
						resolvedStyle: outputStyle{
							fillColor:   mustParseHexColor(t, "#111"),
							borderColor: mustParseHexColor(t, "#222"),
							textColor:   mustParseHexColor(t, "#333"),
							borderWidth: 11,
							fontFamily:  "Test Font",
							fontSize:    22,
							fontWeight:  cairo.FontWeightBold,
				...
				Outputs: []*Output{
					{
						...
						Mode: "1920x1080@59.960",
						resolvedStyle: outputStyle{
							fillColor:   mustParseHexColor(t, "#0a0a0a"),
							borderColor: pickBorderColor(mustParseHexColor(t, "#0a0a0a")),
							textColor:   lightTextColor,
							borderWidth: defaultBorderWidth,
							fontFamily:  defaultFontFamily,
							fontSize:    defaultFontSize,
					...
					},
					{
						...
						Mode: "1920x1080@59.960",
						resolvedStyle: outputStyle{
							fillColor:   mustParseHexColor(t, "#fafafa"),
							borderColor: pickBorderColor(mustParseHexColor(t, "#fafafa")),
...
func mustParseHexColor(t *testing.T, hex string) color.RGBA {
	...
	if err != nil {
		t.Fatalf("failed to parse hex color %q: %v", hex, err)
	}
	return c
}
